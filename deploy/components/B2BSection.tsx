...
export default function B2BSection() {
  return (
    <section id="b2b" className="px-4 sm:px-10 py-10 sm:py-16" style={{ background: '#F0F4FA' }}>
      <div className="mb-8 sm:mb-10 text-center">
        <p className="text-[11px] font-bold tracking-[1.5px] uppercase mb-2" style={{ color: '#1976D2' }}>IT4Everyone B2B</p>
        <h2 className="text-[24px] sm:text-[30px] font-extrabold" style={{ color: '#0D2B5E' }}>Hardware for business</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-10">
        {[
          ...
          <div key={title} className="rounded-2xl p-5 sm:p-7 bg-white border flex flex-col gap-3" style={{ borderColor: '#DDE5EF', boxShadow: '0 2px 12px rgba(13,43,94,0.06)' }}>
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
        <Link href="/contact" className="btn-primary px-6 py-3 text-[14px] text-center" style={{ borderRadius: '8px' }}>
          Get started
        </Link>
        <Link href="/services" className="px-6 py-3 rounded-lg text-[14px] font-bold border-2 transition-all text-center" style={{ background: 'transparent', color: '#0D2B5E', borderColor: '#0D2B5E' }}>
          Learn more
        </Link>
      </div>
    </section>
