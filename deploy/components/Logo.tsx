export default function Logo() {
  return (
    <svg width="220" height="48" viewBox="0 0 220 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="IT4Everyone Ltd">
      ...
      <text x="83" y="22" fontFamily="Segoe UI,system-ui,sans-serif" fontWeight="800" fontSize="17" fill="#1976D2" letterSpacing="0.3">4</text>
      <text x="92" y="22" fontFamily="Segoe UI,system-ui,sans-serif" fontWeight="800" fontSize="17" fill="#0D2B5E" letterSpacing="0.3">EVERYONE</text>
