      ...
      <section className="px-10 py-14" style={{ background: '#F8FAFC' }}>
        <div className="mb-8">
          ...
          <p className="text-[14px] mt-2 max-w-lg leading-[1.75]" style={{ color: '#546E7A' }}>
            Download, complete and email the relevant form to sraper@it4eo.co.uk to get started with IT4Everyone.
          </p>
        </div>
        <div className="grid grid-cols-3 gap-5">
          {[
            ...
            <div key={title} className="bg-white rounded-2xl p-7 flex flex-col gap-4" style={{ border: '1px solid #E8EDF5', boxShadow: '0 2px 8px rgba(13,43,94,0.06)' }}>
              ...
              <a href={file} download className="mt-auto inline-flex items-center gap-2 px-5 py-2.5 text-[13px] font-bold text-white rounded-lg transition-all" style={{ background: 'linear-gradient(135deg, #1565C0, #2196F3)' }}>⬇ Download PDF</a>
            </div>
          ))}
        </div>
      </section>
